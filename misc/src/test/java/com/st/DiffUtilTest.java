...
import com.st.diff.checker.DiffUtils;
...
//        Assert.assertFalse(DiffUtils.diffChecker(6, 8, 9));
        Assert.assertFalse(DiffUtils.diffChecker(24, 12, 18, 6, 100));
    }

    @Test
    public void testBubbleSort() {

        int[] sorted = DiffUtils.bubbleSort(10, 2, 8, 6, 4, 0);
//        DiffUtils.bubbleSort(new int[]{10, 2, 8, 6, 4, 0});
